...
if visualisasi == "Metode Extreme Learning Machine":
    ...
    with tab6:
        ...
        Dki5 = pd.read_excel("D:/Data/Kuliah/TA/Projek-Capstone-Design/DATA/Preprocessing/balance data testing 20%.xlsx")
        st.write(Dki5)
    ...
    def main():
        ...
        if st.button("Proses"):
            ...
            if any(pd.isnull([PM10, SO2, CO, O3, NO2])):
                ...
                training_data = pd.read_excel('D:/Data/Kuliah/TA/Projek-Capstone-Design/DATA/Preprocessing/balance data train 80%.xlsx')  
